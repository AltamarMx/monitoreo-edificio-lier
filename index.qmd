...
![](img/qrcode_posgrado.png){fig-align="center"}
...
## IoT smartwatch para confort térmico

::: columns

::: column
**Objetivo**  
Presentar un smartwatch IoT para la recolección de datos de confort térmico basado en tecnologías abiertas.

**Encuestas horarias**  
- Nivel de aislamiento de la ropa (clo) ¿
- Actividad metabólica (met)  
- Ubicación 
- Sensación térmica y aceptación 
:::

::: column
**Mediciones fisiológicas**  
- Temperatura de piel en muñeca 
- Frecuencia cardíaca 

**Hardware de bajo costo**  
- XIAO ESP32C3, GY-906, MAX30102, XIAO Round Display  
- Publicación de datos en tiempo real en plataforma IoT 
:::
...
![](img/qr_altamar.png){fig-align="center"} 